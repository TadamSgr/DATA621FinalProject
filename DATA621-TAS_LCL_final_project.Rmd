---
title: 'DATA 621 Project: Multi-centre modelling for Newborn Length of Stay in Intensive Care Units based on Diagnoses'
output:
  html_document:
    df_print: paged
---
...
\begin{aligned}
\begin{split}
ln \biggl(\frac{P(Discharge = Home)}{\text{P(Discharge = Short Term Hospital})} \biggl) &= \hat\beta_{1,0} + \hat\beta_{1,Preterm1}\times X_{1,Preterm1} + \hat\beta_{1,Preterm2}\times X_{1,Preterm2} + {} \\
&\qquad\qquad
\hat\beta_{1,Respiratory}\times X_{1,Respiratory} + \hat\beta_{1,Sepsis}\times X_{1,Sepsis}
\\
\\
ln \biggl(\frac{P(Discharge = Home Health Care)}{\text{P(Discharge = Short Term Hospital}} \biggl) &= \hat\beta_{2,0} + \hat\beta_{2,Preterm}\times X_{2,Preterm} + \hat\beta_{1,Preterm2}\times X_{1,Preterm2} +{} \\
&\qquad\qquad
...
\begin{aligned}
\begin{split}
ln \biggl(\frac{P(Discharge = Home)}{\text{P(Discharge = Short Term Hospital})} \biggl) &= 16.0918 + 0.5857\times X_{1,Preterm1} + -1.0933\times X_{1,Preterm2} + {} \\
&\qquad\qquad
-15.3190\times X_{1,Respiratory} +-0.2733\times X_{1,Sepsis}
\\
\\
ln \biggl(\frac{P(Discharge = Home Health Care)}{\text{P(Discharge = Short Term Hospital}} \biggl) &= 15.4580 + 0.2125\times X_{2,Preterm} + -1.3807\times X_{1,Preterm2} +{} \\
&\qquad\qquad
